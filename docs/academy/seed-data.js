/**
 * Academy Seed Script
 * Run: npx convex run academy:seedLevel '{...}'
 * Or use this helper to batch-seed all levels.
 * 
 * Usage from CLI:
 *   npx convex run academy:seedLevel '{"order":1,"title":"Market Foundations","subtitle":"Freshman","color":"hsl(221 83% 53%)","description":"Learn the basics of financial markets.","lessons":[...]}'
 * 
 * This file documents the JSON structure for each level.
 * Copy-paste each block into the CLI or use the admin CRUD UI.
 */
...
module.exports = { LEVEL_1, LEVEL_2, LEVEL_3, LEVEL_4 };
